...
STATIC STM32_FIRMWARE_PROTOCOL *mFwProtocol;
  ...
  )
{
  ...
  //    */
  //   Status = mFwProtocol->GetMaxClockRate (0x000000003, &Rate);
  ...
  if (Rate != 0) {
    ...
    Status = mFwProtocol->SetClockRate (0x000000003, Rate, 1);
    if (Status != EFI_SUCCESS) {
  ...
  Status = mFwProtocol->GetClockRate (0x000000003, &Rate);
  if (Status != EFI_SUCCESS) {
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gSTM32FirmwareProtocolGuid,
